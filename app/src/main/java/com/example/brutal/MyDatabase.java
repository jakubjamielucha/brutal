        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                BuildingModel building = new BuildingModel(cursor.getString(0), cursor.getString(1), cursor.getString(2), cursor.getString(3)
                        ...
                        , cursor.getString(10), cursor.getString(11), cursor.getString(12), cursor.getString(11), cursor.getString(12));
  //                Log.w("DBD", cursor.getString(0));
  //              Log.w("DBD", cursor.getString(2));
